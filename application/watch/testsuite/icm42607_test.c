...
void icm42607_test_thread(void)
{
	const char *const label = DT_LABEL(DT_INST(0, invensense_icm42607));
...
#endif
	while (1){
		process_icm42605(icm42605);
		k_sleep(K_MSEC(2000));
	}	
}


K_THREAD_DEFINE(icm42607, 
			2048,
			icm42607_test_thread, 
			NULL, NULL, NULL,
			10,
			0, 
			0);