...
VOID map_decode()
{
    ...
    if (file_data)
    {
        _gx_system_memory_free((void *)file_data);
        file_data = GX_NULL;
    }
}
...
VOID map_delete()
{
    ...
    {
        _gx_system_memory_free((void *)decoded_map.gx_pixelmap_data);
        decoded_map.gx_pixelmap_data = GX_NULL;
    }

    if (decoded_map.gx_pixelmap_aux_data)
    {
        _gx_system_memory_free((void *)decoded_map.gx_pixelmap_aux_data);
    ...
    {
        _gx_system_memory_free((void *)resized_map.gx_pixelmap_aux_data);
