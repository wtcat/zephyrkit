...
void app_setting_system_reboot_page_init(GX_WINDOW *window)
{
	...
	setting_system_page_children_reg(&curr_page, 0);

	GX_WIDGET *parent = &curr_page;

	GX_STRING string_for_button;
	string_for_button.gx_string_ptr = "reboot";
	...
	custom_slide_button_create(&reboot_button, REBOOT_BUTTON_ID, parent, &childSize, GX_COLOR_ID_HONBOW_DARK_GRAY,
							   GX_COLOR_ID_HONBOW_GREEN, GX_PIXELMAP_ID_APP_SETTING_BTN_RESTART, &string_for_button,
