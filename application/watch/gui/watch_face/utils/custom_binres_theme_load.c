...
static UINT _gx_binres_theme_header_load(GX_BINRES_DATA_INFO *info,
										 GX_THEME_HEADER *header)
{
	memcpy((GX_BYTE *)&header->gx_theme_header_magic_number,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_theme_header_index,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_theme_header_color_count,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_theme_header_palette_count,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_theme_header_font_count,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_theme_header_pixelmap_count,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy(
		(GX_BYTE *)&header->gx_theme_header_vscroll_appearance.gx_scroll_width,
		info->gx_binres_root_address + info->gx_binres_read_offset,
		sizeof(GX_VALUE));
	info->gx_binres_read_offset += sizeof(GX_VALUE);

	memcpy((GX_BYTE *)&header->gx_theme_header_vscroll_appearance
	...
	memcpy(
		(GX_BYTE *)&header->gx_theme_header_hscroll_appearance.gx_scroll_width,
		info->gx_binres_root_address + info->gx_binres_read_offset,
		sizeof(GX_VALUE));
	info->gx_binres_read_offset += sizeof(GX_VALUE);

	memcpy((GX_BYTE *)&header->gx_theme_header_hscroll_appearance
			   .gx_scroll_thumb_width,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_VALUE));
	info->gx_binres_read_offset += sizeof(GX_VALUE);
	...
	memcpy((GX_BYTE *)&header->gx_theme_header_vscroll_style,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_theme_header_hscroll_style,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_theme_header_color_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_theme_header_palette_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_theme_header_font_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_theme_header_pixelmap_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_theme_header_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_color_header_load(GX_BINRES_DATA_INFO *info,
										 GX_COLOR_HEADER *header)
{
	memcpy((GX_BYTE *)&header->gx_color_header_magic_number,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_color_header_color_count,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_color_header_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_palette_header_load(GX_BINRES_DATA_INFO *info,
										   GX_PALETTE_HEADER *header)
{
	memcpy((GX_BYTE *)&header->gx_palette_header_magic_number,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_palette_header_color_count,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_palette_header_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_font_header_load(GX_BINRES_DATA_INFO *info,
										GX_FONT_HEADER *header)
{
	memcpy((GX_BYTE *)&header->gx_font_header_magic_number,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_font_header_index,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_font_header_page_count,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_font_header_deault,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_font_header_bits,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_font_header_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_font_header_data_offset,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_page_header_load(GX_BINRES_DATA_INFO *info,
										GX_PAGE_HEADER *header)
{
	ULONG read_data = 0;

	memcpy((GX_BYTE *)&header->gx_page_header_magic_number,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_page_header_index,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_page_header_format,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_page_header_prespace,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_page_header_postspace,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_page_header_line_height,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_page_header_baseline,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);
	...
	memcpy((GX_BYTE *)&header->gx_page_header_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_glyph_header_load(GX_BINRES_DATA_INFO *info,
										 GX_GLYPH_HEADER *header)
{
	memcpy((GX_BYTE *)&header->gx_glyph_header_magic_number,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_glyph_header_map_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_glyph_header_index,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_glyph_header_ascent,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(SHORT));
	info->gx_binres_read_offset += sizeof(SHORT);

	memcpy((GX_BYTE *)&header->gx_glyph_header_descent,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(SHORT));
	info->gx_binres_read_offset += sizeof(SHORT);

	memcpy((GX_BYTE *)&header->gx_glyph_header_advance,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_glyph_header_leading,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_BYTE));
	info->gx_binres_read_offset += sizeof(GX_BYTE);

	memcpy((GX_BYTE *)&header->gx_glyph_header_width,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_glyph_header_height,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_glyph_header_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);
...
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_kerning_glyph_header_load(
	GX_BINRES_DATA_INFO *info, GX_KERNING_GLYPH_HEADER *header)
{
	_gx_binres_glyph_header_load(info, (GX_GLYPH_HEADER *)header);

	memcpy((GX_BYTE *)&header->gx_glyph_header_kerning_table_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_pixelmap_header_load(GX_BINRES_DATA_INFO *info,
											GX_PIXELMAP_HEADER *header)
{
	memcpy((GX_BYTE *)&header->gx_pixelmap_header_magic_number,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_index,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_version_major,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_version_minor,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_flags,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_format,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_UBYTE));
	info->gx_binres_read_offset += sizeof(GX_UBYTE);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_map_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_aux_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_transparent_color,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(GX_COLOR));
	info->gx_binres_read_offset += sizeof(GX_COLOR);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_width,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_height,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(USHORT));
	info->gx_binres_read_offset += sizeof(USHORT);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_data_size,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);

	memcpy((GX_BYTE *)&header->gx_pixelmap_header_data_offset,
		   info->gx_binres_root_address + info->gx_binres_read_offset,
		   sizeof(ULONG));
	info->gx_binres_read_offset += sizeof(ULONG);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_theme_buffer_allocate(GX_BINRES_DATA_INFO *info,
											 INT theme_id)
{
	...
	for (theme_index = 0;
		 theme_index < res_header.gx_resource_header_theme_count;
		 theme_index++) {
		...
		if (theme_index == theme_id) {
			...
			if (theme_header.gx_theme_header_color_data_size) {
				info->gx_binres_read_offset +=
					theme_header.gx_theme_header_color_data_size;
			}

			/* Palette table buffer size.  */
			if (theme_header.gx_theme_header_palette_data_size) {
				info->gx_binres_read_offset +=
					theme_header.gx_theme_header_palette_data_size;
			}

			/* Font table buffer size.  */
			if (theme_header.gx_theme_header_font_data_size) {
				/* Font count is USHORT type, overflow cannot occur. */
				info->gx_binres_buffer_size +=
					sizeof(GX_FONT *) * theme_header.gx_theme_header_font_count;

				for (font_index = 0;
					 font_index < theme_header.gx_theme_header_font_count;
					 font_index++) {
					_gx_binres_font_header_load(info, &font_header);

					if (font_header.gx_font_header_magic_number !=
						GX_MAGIC_NUMBER) {
						return GX_INVALID_FORMAT;
					}
					...
					if (font_header.gx_font_header_data_offset) {
						...
						info->gx_binres_read_offset =
							font_header.gx_font_header_data_offset;
					...
					for (page_index = 0;
						 page_index < font_header.gx_font_header_page_count;
						 page_index++) {
						/* Load page header. */
						_gx_binres_page_header_load(info, &page_header);
						info->gx_binres_read_offset +=
							page_header.gx_page_header_data_size;

						if (page_header.gx_page_header_magic_number !=
							GX_MAGIC_NUMBER) {
							return GX_INVALID_FORMAT;
						}
#if defined(GX_EXTENDED_UNICODE_SUPPORT)
						if (page_header.gx_page_header_last_glyph >
							GX_MAX_GLYPH_CODE) {
						...
						GX_UTILITY_MATH_UINT_ADD(info->gx_binres_buffer_size,
												 temp,
												 info->gx_binres_buffer_size);
					}
			...
			if (theme_header.gx_theme_header_pixelmap_data_size) {
				...
				temp =
					((UINT)(theme_header.gx_theme_header_pixelmap_count + 1)) *
					sizeof(GX_PIXELMAP *);
				temp += sizeof(GX_PIXELMAP) *
						theme_header.gx_theme_header_pixelmap_count;

				GX_UTILITY_MATH_UINT_ADD(info->gx_binres_buffer_size, temp,
										 info->gx_binres_buffer_size);

				info->gx_binres_read_offset +=
					theme_header.gx_theme_header_pixelmap_data_size;
			}

			break;
		} else {
			info->gx_binres_read_offset +=
				theme_header.gx_theme_header_data_size;
		}
	}

	info->gx_binres_buffer =
		(GX_UBYTE *)_gx_system_memory_allocator(info->gx_binres_buffer_size);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_glyphs_address_get(GX_BINRES_DATA_INFO *info,
										  USHORT glyph_count,
										  GX_CONST GX_GLYPH **returned_glyphs)
{
	GX_GLYPH_HEADER header;
	GX_GLYPH *glyphs;
	USHORT index = 0;
	...
	glyphs =
		(GX_GLYPH *)(info->gx_binres_buffer + info->gx_binres_buffer_index);
	...
	for (index = 0; index < glyph_count; index++) {
		...
		if (header.gx_glyph_header_data_size) {
			glyphs[index].gx_glyph_map =
				(GX_UBYTE *)(info->gx_binres_root_address +
							 info->gx_binres_read_offset);
...
#ifdef GX_FONT_KERNING_SUPPORT
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_kerning_glyphs_address_get(
	GX_BINRES_DATA_INFO *info, USHORT glyph_count,
	GX_CONST GX_KERNING_GLYPH **returned_glyphs)
{
	...
	glyphs = (GX_KERNING_GLYPH *)(info->gx_binres_buffer +
								  info->gx_binres_buffer_index);
	...
	for (index = 0; index < glyph_count; index++) {
		...
		if (header.gx_glyph_header_kerning_table_size) {
			glyphs[index].gx_kerning_table =
				(GX_UBYTE *)(info->gx_binres_root_address +
							 info->gx_binres_read_offset);
			info->gx_binres_read_offset +=
				header.gx_glyph_header_kerning_table_size;
		}
	}
	...
	GX_CONST GX_COMPRESSED_GLYPH **returned_glyphs)
{
	...
	glyphs = (GX_COMPRESSED_GLYPH *)(info->gx_binres_buffer +
									 info->gx_binres_buffer_index);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_font_load(GX_BINRES_DATA_INFO *info, USHORT page_count,
								 GX_FONT **return_font)
{
	...
	for (index = 0; index < page_count; index++) {
		...
		font =
			(GX_FONT *)(info->gx_binres_buffer + info->gx_binres_buffer_index);
		...
		/* Read glyphs data.  */
		glyph_count =
			(USHORT)(font->gx_font_last_glyph - font->gx_font_first_glyph + 1);

		if (font->gx_font_format & GX_FONT_FORMAT_COMPRESSED) {
			status = _gx_binres_compressed_glyphs_address_get(
				info, glyph_count,
				&font->gx_font_glyphs.gx_font_compressed_glyphs);
		}
#if defined(GX_FONT_KERNING_SUPPORT)
		else if (font->gx_font_format & GX_FONT_FORMAT_KERNING) {
			status = _gx_binres_kerning_glyphs_address_get(
				info, glyph_count,
				&font->gx_font_glyphs.gx_font_kerning_glyphs);
		}
#endif /* GX_FONT_KERNING_SUPPORT */
		else {
			status = _gx_binres_glyphs_address_get(
				info, glyph_count, &font->gx_font_glyphs.gx_font_normal_glyphs);
		}
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_color_table_load(GX_BINRES_DATA_INFO *info,
										USHORT color_count,
										GX_COLOR **returned_color_table)
{
	GX_COLOR_HEADER header;
	...
	color_table = (GX_COLOR *)(info->gx_binres_root_address +
							   info->gx_binres_read_offset);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_palette_table_load(GX_BINRES_DATA_INFO *info,
										  USHORT color_count,
										  GX_COLOR **returned_palette_table)
{
	GX_PALETTE_HEADER header;
	...
	palette_table = (GX_COLOR *)(info->gx_binres_root_address +
								 info->gx_binres_read_offset);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_font_table_load(GX_BINRES_DATA_INFO *info,
									   USHORT table_size,
									   GX_FONT ***returned_font_table)
{
	UINT status = GX_SUCCESS;
	GX_FONT_HEADER header;
	...
	for (index = 0; index < table_size; index++) {
		...
		if (header.gx_font_header_deault) {
			...
			status = _gx_binres_font_load(
				info, header.gx_font_header_page_count, &font_table[index]);
...
/**************************************************************************/
#ifdef GX_BINARY_RESOURCE_SUPPORT
static UINT _gx_binres_pixelmap_table_load(
	GX_BINRES_DATA_INFO *info, USHORT table_size,
	GX_PIXELMAP ***returned_pixelmap_table)
{
	UINT status = GX_SUCCESS;
	GX_PIXELMAP_HEADER header;
	...
	pixelmap_table =
		(GX_PIXELMAP **)(info->gx_binres_buffer + info->gx_binres_buffer_index);
	...
	for (index = 1; index < table_size; index++) {
		...
		while (keep_looping) {
			...
			pixelmap_table[index] =
				(GX_PIXELMAP *)(info->gx_binres_buffer +
								info->gx_binres_buffer_index);
		...
		pixelmap_table[index]->gx_pixelmap_aux_data_size =
			header.gx_pixelmap_header_aux_data_size;
		pixelmap_table[index]->gx_pixelmap_data_size =
			header.gx_pixelmap_header_map_size;
		pixelmap_table[index]->gx_pixelmap_flags =
			header.gx_pixelmap_header_flags;
		pixelmap_table[index]->gx_pixelmap_format =
			header.gx_pixelmap_header_format;
		pixelmap_table[index]->gx_pixelmap_width =
			(GX_VALUE)header.gx_pixelmap_header_width;
		pixelmap_table[index]->gx_pixelmap_height =
			(GX_VALUE)header.gx_pixelmap_header_height;
		pixelmap_table[index]->gx_pixelmap_transparent_color =
			header.gx_pixelmap_header_transparent_color;
		pixelmap_table[index]->gx_pixelmap_version_major =
			header.gx_pixelmap_header_version_major;
		pixelmap_table[index]->gx_pixelmap_version_minor =
			header.gx_pixelmap_header_version_minor;

		/* Skip padding bytes. */
		info->gx_binres_read_offset =
			(info->gx_binres_read_offset + 3) & (~0x03UL);

		/* Read pixelmap data.  */
		size = pixelmap_table[index]->gx_pixelmap_data_size;
		if (size) {
			pixelmap_table[index]->gx_pixelmap_data =
				(GX_UBYTE *)(info->gx_binres_root_address +
							 info->gx_binres_read_offset);
		...
		if (size) {
			pixelmap_table[index]->gx_pixelmap_aux_data =
				(GX_UBYTE *)(info->gx_binres_root_address +
							 info->gx_binres_read_offset);
			info->gx_binres_read_offset += size;
		}
	...
	if (status == GX_SUCCESS) {
		for (index = 0;; index++) {
			...
			if (index == theme_id) {
				...
				theme->theme_vertical_scrollbar_appearance =
					theme_header.gx_theme_header_vscroll_appearance;
				theme->theme_horizontal_scrollbar_appearance =
					theme_header.gx_theme_header_hscroll_appearance;
				theme->theme_vertical_scroll_style =
					theme_header.gx_theme_header_hscroll_style;
				theme->theme_horizontal_scroll_style =
					theme_header.gx_theme_header_hscroll_style;

				/* Read color table.  */
				status = _gx_binres_color_table_load(
					&info, theme_header.gx_theme_header_color_count,
					&theme->theme_color_table);

				/* Read palette table.  */
				if ((status == GX_SUCCESS) &&
					theme_header.gx_theme_header_palette_data_size) {
					status = _gx_binres_palette_table_load(
						&info, theme_header.gx_theme_header_palette_count,
						&theme->theme_palette);
				}

				/* Read font table.  */
				if ((status == GX_SUCCESS) &&
					theme_header.gx_theme_header_font_data_size) {
					status = _gx_binres_font_table_load(
						&info, theme_header.gx_theme_header_font_count,
				...
				if ((status == GX_SUCCESS) &&
					theme_header.gx_theme_header_pixelmap_data_size) {
					status = _gx_binres_pixelmap_table_load(
						&info,
						(USHORT)(theme_header.gx_theme_header_pixelmap_count +
								 1),
						&theme->theme_pixelmap_table);
				}

				if (status == GX_SUCCESS) {
					*buff_addr = info.gx_binres_buffer;
...
{
	if ((_gx_system_memory_free != NULL) && (NULL != *buff_addr)) {
		_gx_system_memory_free(*buff_addr);
	}
	*buff_addr = NULL;
}
#endif
