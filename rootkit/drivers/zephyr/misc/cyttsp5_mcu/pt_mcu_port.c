...
static int pt_i2c_probe(const struct device *dev __unused)
{
...
{
#if 0
	del_timer_sync(&timer_60hz);
	if (g_cdata)
		pt_setup_irq(g_cdata, 0);
...
#endif
SYS_INIT(pt_i2c_probe, POST_KERNEL, CONFIG_KERNEL_INIT_PRIORITY_DEVICE + 5);
