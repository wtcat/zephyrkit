...
static void gh30x_fifo_evt_hb_mode_calc(int32_t *dbg_rawdata_ptr)
{
...
static void gh30x_fifo_evt_spo2_mode_calc(int32_t *dbg_rawdata_ptr)
{
    ...
    else
    {
        ...
        SEND_MCU_SPO2_MODE_RESULT(spo2_value, spo2_lvl, hb_value, hb_lvl, hrv_val, hrv_lvl, hrv_cnt, spo2_r_value, wearing_state, valid_lvl, abnormal_state, (GS32 (*)[DBG_MCU_MODE_PKG_LEN])dbg_rawdata_ptr, dbg_rawdata_len);
    }
...
{
    uint16_t dbg_rawdata_len = __ALGO_CALC_DBG_BUFFER_LEN__;
    uint16_t hrv_rr_value_array[HRV_MODE_RES_MAX_CNT] = {0};
    ...
    SEND_MCU_HRV_MODE_RESULT(hrv_rr_value_array, hrv_rr_value_fresh_cnt, hrv_lvl, 0, (GS32 (*)[DBG_MCU_MODE_PKG_LEN])dbg_rawdata_ptr, dbg_rawdata_len);
