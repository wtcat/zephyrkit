...
#ifndef ZEPHYR_DRIVERS_SENSOR_ICM42607_ICM42607_SETUP_H_
#define ZEPHYR_DRIVERS_SENSOR_ICM42607_ICM42607_SETUP_H_
...
int icm42607_set_odr(const struct device *dev, int a_rate, int g_rate);

#endif /* __SENSOR_ICM42607_ICM42607_SETUP__ */
