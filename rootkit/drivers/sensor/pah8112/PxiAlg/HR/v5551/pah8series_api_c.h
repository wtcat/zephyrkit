...
PXIALG_API uint8_t  pah8series_get_flag_forced_out(uint8_t *flag_forced_out);
PXIALG_API uint8_t  pah8series_get_smooth_hr(float *smooth_hr);
#if FW == 0
PXIALG_API uint8_t  pah8series_set_debug_file_print_en(uint8_t en, char *path);
#endif
#ifdef __cplusplus
}
#endif // __cplusplus
