...
#define GX_MULTI_LINE_TEXT_VIEW_BIDI_RESOLVED_TEXT_INFO                                                                \
	GX_BIDI_RESOLVED_TEXT_INFO *gx_multi_line_text_view_bidi_resolved_text_info;
#define GX_TEXT_SCROLL_WHEEL_BIDI_RESOLVED_TEXT_INFO                                                                   \
	GX_BIDI_RESOLVED_TEXT_INFO **gx_text_scroll_wheel_bidi_resolved_text_info;
#else
...
#define GX_FONT_FORMAT_REVERSED_ORDER                                                                                  \
	0x80 /* For 4bpp font, half bytes order reversed. For 1bpp font, bits order reversed with least signigicant bit in \
			left. */
...
typedef struct GX_DISPLAY_STRUCT {
	...
	(GX_DRAW_CONTEXT *context, INT x1, INT x2, INT ypos, INT width, GX_COLOR color);
	...
	(GX_DRAW_CONTEXT *context, INT y1, INT y2, INT xpos, INT width, GX_COLOR color);
	...
	(GX_DRAW_CONTEXT *context, INT xpos, INT ypos, GX_PIXELMAP *pmp, GX_UBYTE alpha);
	...
	(GX_DRAW_CONTEXT *context, INT xpos, INT ypos, GX_PIXELMAP *pixelmap, INT angle, INT rot_cx, INT rot_cy);
	...
	(GX_DRAW_CONTEXT *context, GX_RECTANGLE *draw_area, GX_POINT *map_offset, GX_CONST GX_GLYPH *glyph);
	...
	(GX_DRAW_CONTEXT *context, INT xcenter, INT ycenter, UINT r, INT start_angle, INT end_angle);
	...
	(GX_DRAW_CONTEXT *context, INT xcenter, INT ycenter, INT a, INT b);
	...
	VOID(*gx_display_driver_anti_aliased_wide_ellipse_draw)
	(GX_DRAW_CONTEXT *context, INT xcenter, INT ycenter, INT a, INT b);
	...
	VOID(*gx_display_mouse_define)
	(struct GX_DISPLAY_STRUCT *display, struct GX_CANVAS_STRUCT *canvas, GX_MOUSE_CURSOR_INFO *info);
...
typedef struct GX_CANVAS_STRUCT {
	...
	struct GX_CANVAS_STRUCT *gx_canvas_created_next, *gx_canvas_created_previous;
...
#define gx_circular_gauge_create(a, b, c, d, e, f, g, h, i)                                                            \
	_gx_circular_gauge_create((GX_CIRCULAR_GAUGE *)a, b, c, d, e, f, g, h, i)
...
#define gx_horizontal_list_create(a, b, c, d, e, f, g, h)                                                              \
	_gx_horizontal_list_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#define gx_multi_line_text_button_create(a, b, c, d, e, f, g)                                                          \
	_gx_multi_line_text_button_create(a, b, (GX_WIDGET *)c, d, e, f, g)
...
#define gx_multi_line_text_input_create(a, b, c, d, e, f, g, h)                                                        \
	_gx_multi_line_text_input_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#define gx_multi_line_text_view_create(a, b, c, d, e, f, g)                                                            \
	_gx_multi_line_text_view_create(a, b, (GX_WIDGET *)c, d, e, f, g)
...
#define gx_multi_line_text_view_text_color_set(a, b, c)                                                                \
	_gx_multi_line_text_view_text_color_set((GX_MUILTI_LINE_TEXT_VIEW *)a, b, c, b)
#else
...
#define gx_numeric_scroll_wheel_create(a, b, c, d, e, f, g, h)                                                         \
	_gx_numeric_scroll_wheel_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
#define gx_numeric_scroll_wheel_range_set _gx_numeric_scroll_wheel_range_set

#define gx_pixelmap_button_create(a, b, c, d, e, f, g, h, i)                                                           \
	_gx_pixelmap_button_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, i)
...
#define gx_pixelmap_prompt_create(a, b, c, d, e, f, g, h)                                                              \
	_gx_pixelmap_prompt_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#define gx_pixelmap_slider_create(a, b, c, d, e, f, g, h)                                                              \
	_gx_pixelmap_slider_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_radial_progress_bar_text_color_set(a, b, c)                                                                 \
	_gx_radial_progress_bar_text_color_set((GX_RADIAL_PROGRESS_BAR *)a, b, c, b)
#else
...
#define gx_single_line_text_input_buffer_clear(a)                                                                      \
	_gx_single_line_text_input_buffer_clear((GX_SINGLE_LINE_TEXT_INPUT *)a);
#define gx_single_line_text_input_buffer_get(a, b, c, d)                                                               \
...
#define gx_single_line_text_input_create(a, b, c, d, e, f, g, h)                                                       \
	_gx_single_line_text_input_create(a, b, (GX_WIDGET *)c, d, e, f, g, h)
...
#define gx_single_line_text_input_event_process(a, b)                                                                  \
	_gx_single_line_text_input_event_process((GX_SINGLE_LINE_TEXT_INPUT *)a, b)
#define gx_single_line_text_input_fill_color_set(a, b, c, d, e)                                                        \
	_gx_single_line_text_input_fill_color_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b, c, d, e)
...
#define gx_single_line_text_input_style_add(a, b)                                                                      \
	_gx_single_line_text_input_style_add((GX_SINGLE_LINE_TEXT_INPUT *)a, b);
#define gx_single_line_text_input_style_remove(a, b)                                                                   \
	_gx_single_line_text_input_style_remove((GX_SINGLE_LINE_TEXT_INPUT *)a, b)
#define gx_single_line_text_input_style_set(a, b)                                                                      \
	_gx_single_line_text_input_style_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b)
#define gx_single_line_text_input_text_color_set(a, b, c, d, e)                                                        \
	_gx_single_line_text_input_text_color_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b, c, d, e)
...
#endif
#define gx_string_scroll_wheel_create_ext(a, b, c, d, e, f, g, h)                                                      \
	_gx_string_scroll_wheel_create_ext(a, b, c, d, e, f, g, h)
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_text_scroll_wheel_callback_set(a, b)                                                                        \
	_gx_text_scroll_wheel_callback_set((GX_TEXT_SCROLL_WHEEL *)a,                                                      \
									   (GX_CONST GX_CHAR * (*)(GX_TEXT_SCROLL_WHEEL *, INT)) b)
#endif
#define gx_text_scroll_wheel_callback_set_ext(a, b)                                                                    \
	_gx_text_scroll_wheel_callback_set_ext((GX_TEXT_SCROLL_WHEEL *)a,                                                  \
										   (UINT(*)(GX_TEXT_SCROLL_WHEEL *, INT, GX_STRING *))b)
#define gx_text_scroll_wheel_font_set(a, b, c) _gx_text_scroll_wheel_font_set((GX_TEXT_SCROLL_WHEEL *)a, b, c)
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_text_scroll_wheel_text_color_set(a, b, c)                                                                   \
	_gx_text_scroll_wheel_text_color_set((GX_TEXT_SCROLL_WHEEL *)a, b, c, b)
#else
#define gx_text_scroll_wheel_text_color_set(a, b, c, d)                                                                \
...
#define gx_widget_event_process_set(a, b)                                                                              \
	_gx_widget_event_process_set((GX_WIDGET *)a, (UINT(*)(GX_WIDGET *, GX_EVENT *))b)
...
/* Define the non-error checking function prototypes of the GUIX API.  These are the routines called when the
   application code is built with GX_DISABLE_ERROR_CHECKING defined.  */

UINT _gx_accordion_menu_create(GX_ACCORDION_MENU *accordion, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style,
...
UINT _gx_button_create(GX_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style, USHORT Id,
...
UINT _gx_canvas_create(GX_CANVAS *canvas, GX_CONST GX_CHAR *name, GX_DISPLAY *display, UINT type, UINT width,
...
UINT _gx_canvas_pixelmap_rotate(GX_VALUE x_position, GX_VALUE y_position, GX_PIXELMAP *pixelmap, INT angle, INT rot_cx,
								INT rot_cy);
...
UINT _gx_checkbox_create(GX_CHECKBOX *checkbox, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID text_id,
...
UINT _gx_circular_gauge_create(GX_CIRCULAR_GAUGE *circular_gauge, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
							   GX_CIRCULAR_GAUGE_INFO *circular_gauge_info, GX_RESOURCE_ID background, ULONG style,
							   USHORT circular_gauge_id, GX_VALUE xpos, GX_VALUE ypos);
...
UINT _gx_display_create(GX_DISPLAY *display, GX_CONST GX_CHAR *name, UINT (*display_driver_setup)(GX_DISPLAY *),
						GX_VALUE xres, GX_VALUE yres);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_display_language_table_get(GX_DISPLAY *display, GX_CHAR ****table, GX_UBYTE *language_count,
									UINT *string_count);
UINT _gx_display_language_table_set(GX_DISPLAY *display, GX_CHAR ***table, GX_UBYTE num_languages,
									UINT number_of_strings);
#endif
UINT _gx_display_language_table_get_ext(GX_DISPLAY *display, GX_STRING ***table, GX_UBYTE *language_count,
										UINT *string_count);
UINT _gx_display_language_table_set_ext(GX_DISPLAY *display, GX_CONST GX_STRING **table, GX_UBYTE num_languages,
										UINT number_of_strings);
...
UINT _gx_drop_list_create(GX_DROP_LIST *drop_list, GX_CONST GX_CHAR *name, GX_WIDGET *parent, INT total_rows,
						  INT open_height, VOID (*callback)(GX_VERTICAL_LIST *, GX_WIDGET *, INT), ULONG style,
						  USHORT drop_list_id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_horizontal_list_create(GX_HORIZONTAL_LIST *horizontal_list, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
...
UINT _gx_icon_button_create(GX_ICON_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID icon_id,
...
UINT _gx_icon_create(GX_ICON *icon, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID pixelmap_id, ULONG style,
...
UINT _gx_image_reader_create(GX_IMAGE_READER *image_reader, GX_CONST GX_UBYTE *read_data, INT read_data_size,
...
UINT _gx_line_chart_create(GX_LINE_CHART *chart, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
						   GX_CONST GX_LINE_CHART_INFO *info, ULONG style, USHORT chart_id,
						   GX_CONST GX_RECTANGLE *size);
...
UINT _gx_menu_create(GX_MENU *menu, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID text_id,
					 GX_RESOURCE_ID fill_id, ULONG style, USHORT menu_id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_multi_line_text_button_create(GX_MULTI_LINE_TEXT_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
...
UINT _gx_multi_line_text_input_create(GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, GX_CONST GX_CHAR *name_ptr,
									  GX_WIDGET *parent, GX_CHAR *input_buffer, UINT buffer_size, ULONG style,
									  USHORT Id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_multi_line_text_input_fill_color_set(GX_MULTI_LINE_TEXT_INPUT *view, GX_RESOURCE_ID normal_id,
...
UINT _gx_multi_line_text_input_text_color_set(GX_MULTI_LINE_TEXT_INPUT *view, GX_RESOURCE_ID normal_id,
											  GX_RESOURCE_ID selected_id, GX_RESOURCE_ID disabled_id,
											  GX_RESOURCE_ID readonly_id);
...
UINT _gx_multi_line_text_view_create(GX_MULTI_LINE_TEXT_VIEW *text_view_ptr, GX_CONST GX_CHAR *name_ptr,
...
UINT _gx_multi_line_text_view_scroll_info_get(GX_MULTI_LINE_TEXT_VIEW *view, ULONG style,
											  GX_SCROLL_INFO *return_scroll_info);
UINT _gx_multi_line_text_view_text_color_set(GX_MULTI_LINE_TEXT_VIEW *view, GX_RESOURCE_ID normal_id,
											 GX_RESOURCE_ID selected_id, GX_RESOURCE_ID disabled_id);
...
UINT _gx_rich_text_view_create(GX_RICH_TEXT_VIEW *rich_view, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
							   GX_RESOURCE_ID text_id, GX_RICH_TEXT_FONTS *fonts, ULONG style, USHORT id,
							   GX_CONST GX_RECTANGLE *size);
...
UINT _gx_numeric_pixelmap_prompt_create(GX_NUMERIC_PIXELMAP_PROMPT *prompt, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
										GX_RESOURCE_ID text_id, GX_RESOURCE_ID fill_id, ULONG style,
										USHORT pixelmap_prompt_id, GX_CONST GX_RECTANGLE *size);
UINT _gx_numeric_pixelmap_prompt_format_function_set(GX_NUMERIC_PIXELMAP_PROMPT *prompt,
...
UINT _gx_numeric_scroll_wheel_create(GX_NUMERIC_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
									 INT start_val, INT end_val, ULONG style, USHORT Id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_pixelmap_button_create(GX_PIXELMAP_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
								...
								ULONG style, USHORT pixelmap_button_id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_pixelmap_prompt_create(GX_PIXELMAP_PROMPT *prompt, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
								GX_RESOURCE_ID text_id, GX_RESOURCE_ID normal_fill_id, ULONG style, USHORT prompt_id,
								GX_CONST GX_RECTANGLE *size);
VOID _gx_pixelmap_prompt_draw(GX_PIXELMAP_PROMPT *prompt);
UINT _gx_pixelmap_prompt_pixelmap_set(GX_PIXELMAP_PROMPT *prompt, GX_RESOURCE_ID normal_left_id,
									  GX_RESOURCE_ID normal_fill_id, GX_RESOURCE_ID normal_right_id,
									  GX_RESOURCE_ID selected_left_id, GX_RESOURCE_ID selected_fill_id,
...
UINT _gx_pixelmap_slider_create(GX_PIXELMAP_SLIDER *slider, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
								GX_SLIDER_INFO *info, GX_PIXELMAP_SLIDER_INFO *pixelmap_info, ULONG style,
								USHORT pixelmap_slider_id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_progress_bar_create(GX_PROGRESS_BAR *progress_bar, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
							 GX_PROGRESS_BAR_INFO *progress_bar_info, ULONG style, USHORT progress_bar_id,
							 GX_CONST GX_RECTANGLE *size);
...
UINT _gx_prompt_create(GX_PROMPT *prompt, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID text_id,
...
UINT _gx_prompt_text_color_set(GX_PROMPT *prompt, GX_RESOURCE_ID normal_text_color_id,
							   GX_RESOURCE_ID selected_text_color_id, GX_RESOURCE_ID disabled_text_color_id);
...
UINT _gx_radial_progress_bar_create(GX_RADIAL_PROGRESS_BAR *progress_bar, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
									GX_RADIAL_PROGRESS_BAR_INFO *progress_bar_info, ULONG style,
...
UINT _gx_radial_progress_bar_text_color_set(GX_RADIAL_PROGRESS_BAR *progress_bar, GX_RESOURCE_ID normal_text_color_id,
...
UINT _gx_radial_slider_pixelmap_set(GX_RADIAL_SLIDER *slider, GX_RESOURCE_ID background_pixelmap,
									GX_RESOURCE_ID needle_pixelmap);
UINT _gx_radial_slider_angle_set(GX_RADIAL_SLIDER *slider, GX_VALUE new_angle);

UINT _gx_radio_button_create(GX_RADIO_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID text_id,
...
UINT _gx_single_line_text_input_create(GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, GX_CONST GX_CHAR *name,
									   GX_WIDGET *parent, GX_CHAR *input_buffer, UINT buffer_size, UINT style,
									   USHORT text_input_id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_single_line_text_input_fill_color_set(GX_SINGLE_LINE_TEXT_INPUT *input, GX_RESOURCE_ID normal_fill_color_id,
...
UINT _gx_single_line_text_input_text_color_set(GX_SINGLE_LINE_TEXT_INPUT *input, GX_RESOURCE_ID normal_text_color_id,
											   GX_RESOURCE_ID selected_text_color_id,
											   GX_RESOURCE_ID disabled_text_color_id,
...
UINT _gx_slider_create(GX_SLIDER *slider, GX_CONST GX_CHAR *name, GX_WIDGET *parent, INT tick_count,
...
UINT _gx_sprite_create(GX_SPRITE *sprite, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_SPRITE_FRAME *frame_list,
					   USHORT framecount, ULONG style, USHORT sprite_id, GX_CONST GX_RECTANGLE *size);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_string_scroll_wheel_create(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
									INT total_rows, GX_CONST GX_CHAR **string_list, ULONG style, USHORT Id,
									GX_CONST GX_RECTANGLE *size);
#endif
UINT _gx_string_scroll_wheel_create_ext(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
										INT total_rows, GX_CONST GX_STRING *string_list, ULONG style, USHORT Id,
										GX_CONST GX_RECTANGLE *size);
UINT _gx_string_scroll_wheel_event_process(GX_STRING_SCROLL_WHEEL *wheel, GX_EVENT *event_ptr);
UINT _gx_string_scroll_wheel_string_id_list_set(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_RESOURCE_ID *string_id_list,
												INT id_count);

#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_string_scroll_wheel_string_list_set(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR **string_list,
											 INT string_count);
#endif
UINT _gx_string_scroll_wheel_string_list_set_ext(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_STRING *string_list,
												 INT string_count);
...
UINT _gx_system_string_width_get(GX_CONST GX_FONT *font, GX_CONST GX_CHAR *string, INT string_length,
...
UINT _gx_text_button_create(GX_TEXT_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID text_id,
							ULONG style, USHORT Id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_text_button_text_color_set(GX_TEXT_BUTTON *text_button, GX_RESOURCE_ID normal_text_color_id,
									GX_RESOURCE_ID selected_text_color_id, GX_RESOURCE_ID disabled_text_color_id);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_text_scroll_wheel_callback_set(GX_TEXT_SCROLL_WHEEL *wheel,
...
UINT _gx_text_scroll_wheel_create(GX_TEXT_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
								  INT total_rows, ULONG style, USHORT Id, GX_CONST GX_RECTANGLE *size);
...
UINT _gx_text_scroll_wheel_font_set(GX_TEXT_SCROLL_WHEEL *wheel, GX_RESOURCE_ID normal_font,
...
UINT _gx_tree_view_create(GX_TREE_VIEW *tree, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style,
						  USHORT tree_view_id, GX_CONST GX_RECTANGLE *size);
...
#endif
UINT _gx_utility_canvas_to_bmp(GX_CANVAS *canvas, GX_RECTANGLE *rect,
							   UINT (*write_data)(GX_UBYTE *byte_data, UINT data_count));
UINT _gx_utility_gradient_create(GX_GRADIENT *gradient, GX_VALUE width, GX_VALUE height, UCHAR type,
...
UINT _gx_utility_pixelmap_simple_rotate(GX_PIXELMAP *src, INT angle, GX_PIXELMAP *destination, INT *rot_cx,
										INT *rot_cy);
...
UINT _gx_utility_rectangle_define(GX_RECTANGLE *rectangle, GX_VALUE left, GX_VALUE top, GX_VALUE right,
								  GX_VALUE bottom);
...
UINT _gx_vertical_list_create(GX_VERTICAL_LIST *vertical_list, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
							  INT total_rows, VOID (*callback)(GX_VERTICAL_LIST *, GX_WIDGET *, INT), ULONG style,
							  USHORT vertical_list_id, GX_CONST GX_RECTANGLE *size);
...
VOID _gx_widget_border_draw(GX_WIDGET *widget, GX_RESOURCE_ID border_color, GX_RESOURCE_ID upper_color,
							GX_COLOR lower_color, GX_BOOL fill);
...
UINT _gx_widget_create(GX_WIDGET *widget, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style, USHORT Id,
					   GX_CONST GX_RECTANGLE *size);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gx_widget_text_blend(GX_WIDGET *widget, UINT tColor, UINT font_id, GX_CONST GX_CHAR *string, INT x_offset,
						   INT y_offset, UCHAR alpha);

VOID _gx_widget_text_draw(GX_WIDGET *widget, UINT tColor, UINT font_id, GX_CONST GX_CHAR *string, INT x_offset,
						  INT y_offset);
#endif
UINT _gx_widget_text_blend_ext(GX_WIDGET *widget, UINT tColor, UINT font_id, GX_CONST GX_STRING *string, INT x_offset,
							   INT y_offset, UCHAR alpha);
VOID _gx_widget_text_draw_ext(GX_WIDGET *widget, UINT tColor, UINT font_id, GX_CONST GX_STRING *string, INT x_offset,
							  INT y_offset);
VOID _gx_widget_text_id_draw(GX_WIDGET *widget, UINT tColor, UINT font_id, UINT text_id, INT x_offset, INT y_offset);
...
UINT _gx_window_create(GX_WINDOW *window, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style, USHORT window_id,
					   GX_CONST GX_RECTANGLE *size);
...
UINT _gx_window_root_create(GX_WINDOW_ROOT *root_window, GX_CONST GX_CHAR *name, GX_CANVAS *canvas, ULONG style,
							USHORT Id, GX_CONST GX_RECTANGLE *size);
...
#define gx_accordion_menu_create(a, b, c, d, e, f)                                                                     \
	_gxe_accordion_menu_create(a, b, c, d, e, f, sizeof(GX_ACCORDION_MENU))
#define gx_accordion_menu_draw _gx_accordion_menu_draw
...
#define gx_checkbox_create(a, b, c, d, e, f, g)                                                                        \
	_gxe_checkbox_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_CHECKBOX))
#define gx_checkbox_draw _gx_checkbox_draw
...
#define gx_circular_gauge_background_draw _gx_circular_gauge_background_draw
#define gx_circular_gauge_create(a, b, c, d, e, f, g, h, i)                                                            \
	_gxe_circular_gauge_create((GX_CIRCULAR_GAUGE *)a, b, c, d, e, f, g, h, i, sizeof(GX_CIRCULAR_GAUGE))
#define gx_circular_gauge_draw _gx_circular_gauge_draw
...
#define gx_drop_list_create(a, b, c, d, e, f, g, h, i)                                                                 \
	_gxe_drop_list_create((GX_DROP_LIST *)a, b, (GX_WIDGET *)c, d, e, f, g, h, i, sizeof(GX_DROP_LIST))
...
#define gx_horizontal_list_create(a, b, c, d, e, f, g, h)                                                              \
	_gxe_horizontal_list_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_HORIZONTAL_LIST))
...
#define gx_horizontal_scrollbar_create(a, b, c, d, e)                                                                  \
	_gxe_horizontal_scrollbar_create(a, b, (GX_WINDOW *)c, d, e, sizeof(GX_SCROLLBAR))

#define gx_icon_background_draw _gx_icon_background_draw
#define gx_icon_button_create(a, b, c, d, e, f, g)                                                                     \
	_gxe_icon_button_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_ICON_BUTTON))
#define gx_icon_button_draw _gx_icon_button_draw
...
#define gx_line_chart_axis_draw _gx_line_chart_axis_draw
#define gx_line_chart_create(a, b, c, d, e, f, g)                                                                      \
	_gxe_line_chart_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_LINE_CHART))
#define gx_line_chart_data_draw _gx_line_chart_data_draw
#define gx_line_chart_draw _gx_line_chart_draw
...
#define gx_menu_create(a, b, c, d, e, f, g, h)                                                                         \
	_gxe_menu_create((GX_MENU *)a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_MENU))
#define gx_menu_draw _gx_menu_draw
...
#define gx_multi_line_text_button_create(a, b, c, d, e, f, g)                                                          \
	_gxe_multi_line_text_button_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_MULTI_LINE_TEXT_BUTTON))
#define gx_multi_line_text_button_draw _gx_multi_line_text_button_draw
...
#define gx_multi_line_text_input_create(a, b, c, d, e, f, g, h)                                                        \
	_gxe_multi_line_text_input_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_MULTI_LINE_TEXT_INPUT))
...
#define gx_multi_line_text_view_create(a, b, c, d, e, f, g)                                                            \
	_gxe_multi_line_text_view_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_MULTI_LINE_TEXT_VIEW))
#define gx_multi_line_text_view_draw _gx_multi_line_text_view_draw
...
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_multi_line_text_view_text_color_set(a, b, c)                                                                \
	_gxe_multi_line_text_view_text_color_set((GX_MULTI_LINE_TEXT_VIEW *)a, b, c, b)
#else
...
#define gx_rich_text_view_create(a, b, c, d, e, f, g, h)                                                               \
	_gxe_rich_text_view_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_RICH_TEXT_VIEW))
#define gx_rich_text_view_draw _gx_rich_text_view_draw
#define gx_rich_text_view_text_draw _gx_rich_text_view_text_draw
#define gx_rich_text_view_fonts_set _gxe_rich_text_view_fonts_set

#define gx_numeric_pixelmap_prompt_create(a, b, c, d, e, f, g, h)                                                      \
	_gxe_numeric_pixelmap_prompt_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_NUMERIC_PIXELMAP_PROMPT))
...
#define gx_numeric_prompt_create(a, b, c, d, e, f, g)                                                                  \
	_gxe_numeric_prompt_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_NUMERIC_PROMPT))
...
#define gx_numeric_scroll_wheel_create(a, b, c, d, e, f, g, h)                                                         \
	_gxe_numeric_scroll_wheel_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_NUMERIC_SCROLL_WHEEL))
#define gx_numeric_scroll_wheel_range_set _gxe_numeric_scroll_wheel_range_set

#define gx_pixelmap_button_create(a, b, c, d, e, f, g, h, i)                                                           \
	_gxe_pixelmap_button_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, i, sizeof(GX_PIXELMAP_BUTTON))
#define gx_pixelmap_button_draw _gx_pixelmap_button_draw
...
#define gx_pixelmap_prompt_create(a, b, c, d, e, f, g, h)                                                              \
	_gxe_pixelmap_prompt_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_PIXELMAP_PROMPT))
#define gx_pixelmap_prompt_draw _gx_pixelmap_prompt_draw
#define gx_pixelmap_prompt_pixelmap_set _gxe_pixelmap_prompt_pixelmap_set

#define gx_pixelmap_slider_create(a, b, c, d, e, f, g, h)                                                              \
	_gxe_pixelmap_slider_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_PIXELMAP_SLIDER))
#define gx_pixelmap_slider_draw _gx_pixelmap_slider_draw
...
#define gx_progress_bar_background_draw _gx_progress_bar_background_draw
#define gx_progress_bar_create(a, b, c, d, e, f, g)                                                                    \
	_gxe_progress_bar_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_PROGRESS_BAR))
#define gx_progress_bar_draw _gx_progress_bar_draw
...
#define gx_radial_progress_bar_background_draw _gx_radial_progress_bar_background_draw
#define gx_radial_progress_bar_create(a, b, c, d, e, f)                                                                \
	_gxe_radial_progress_bar_create(a, b, c, d, e, f, sizeof(GX_RADIAL_PROGRESS_BAR))
#define gx_radial_progress_bar_draw _gx_radial_progress_bar_draw
...
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_radial_progress_bar_text_color_set(a, b, c)                                                                 \
	_gxe_radial_progress_bar_text_color_set((GX_RADIAL_PROGRESS_BAR *)a, b, c, b)
#else
...
#define gx_radial_slider_create(a, b, c, d, e, f, g)                                                                   \
	_gxe_radial_slider_create((GX_RADIAL_SLIDER *)a, b, c, d, e, f, g, sizeof(GX_RADIAL_SLIDER))
#define gx_radial_slider_draw _gx_radial_slider_draw
...
#define gx_radio_button_create(a, b, c, d, e, f, g)                                                                    \
	_gxe_radio_button_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_RADIO_BUTTON))
#define gx_radio_button_draw _gx_radio_button_draw
...
#define gx_scroll_wheel_create(a, b, c, d, e, f, g)                                                                    \
	_gxe_scroll_wheel_create(a, b, c, d, e, f, g, sizeof(GX_SCROLL_WHEEL))
...
#define gx_single_line_text_input_buffer_clear(a)                                                                      \
	_gxe_single_line_text_input_buffer_clear((GX_SINGLE_LINE_TEXT_INPUT *)a);
#define gx_single_line_text_input_buffer_get(a, b, c, d)                                                               \
...
#define gx_single_line_text_input_create(a, b, c, d, e, f, g, h)                                                       \
	_gxe_single_line_text_input_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_SINGLE_LINE_TEXT_INPUT))
#define gx_single_line_text_input_draw(a) _gx_single_line_text_input_draw(a)
...
#define gx_single_line_text_input_event_process(a, b)                                                                  \
	_gxe_single_line_text_input_event_process((GX_SINGLE_LINE_TEXT_INPUT *)a, b)
#define gx_single_line_text_input_fill_color_set(a, b, c, d, e)                                                        \
	_gxe_single_line_text_input_fill_color_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b, c, d, e)
...
#define gx_single_line_text_input_style_add(a, b)                                                                      \
	_gxe_single_line_text_input_style_add((GX_SINGLE_LINE_TEXT_INPUT *)a, b)
#define gx_single_line_text_input_style_remove(a, b)                                                                   \
	_gxe_single_line_text_input_style_remove((GX_SINGLE_LINE_TEXT_INPUT *)a, b)
#define gx_single_line_text_input_style_set(a, b)                                                                      \
	_gxe_single_line_text_input_style_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b)
#define gx_single_line_text_input_text_color_set(a, b, c, d, e)                                                        \
	_gxe_single_line_text_input_text_color_set((GX_SINGLE_LINE_TEXT_INPUT *)a, b, c, d, e)
...
#define gx_slider_create(a, b, c, d, e, f, g, h)                                                                       \
	_gxe_slider_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_SLIDER))
#define gx_slider_draw _gx_slider_draw
...
#define gx_sprite_create(a, b, c, d, e, f, g, h)                                                                       \
	_gxe_sprite_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_SPRITE))
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_string_scroll_wheel_create(a, b, c, d, e, f, g, h)                                                          \
	_gxe_string_scroll_wheel_create(a, b, c, d, e, f, g, h, sizeof(GX_STRING_SCROLL_WHEEL))
#define gx_string_scroll_wheel_string_list_set _gxe_string_scroll_wheel_string_list_set
#endif
#define gx_string_scroll_wheel_create_ext(a, b, c, d, e, f, g, h)                                                      \
	_gxe_string_scroll_wheel_create_ext(a, b, c, d, e, f, g, h, sizeof(GX_STRING_SCROLL_WHEEL))
...
#define gx_text_button_create(a, b, c, d, e, f, g)                                                                     \
	_gxe_text_button_create(a, b, (GX_WIDGET *)c, d, e, f, g, sizeof(GX_TEXT_BUTTON))
#define gx_text_button_draw _gx_text_button_draw
...
#define gx_text_input_cursor_blink_interval_set(a, b)                                                                  \
	_gxe_text_input_cursor_blink_interval_set((GX_TEXT_INPUT_CURSOR *)a, b)
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
#define gx_text_scroll_wheel_callback_set(a, b)                                                                        \
	_gxe_text_scroll_wheel_callback_set((GX_TEXT_SCROLL_WHEEL *)a,                                                     \
										(GX_CONST GX_CHAR * (*)(GX_TEXT_SCROLL_WHEEL *, INT)) b)
#endif
#define gx_text_scroll_wheel_callback_set_ext(a, b)                                                                    \
	_gxe_text_scroll_wheel_callback_set_ext((GX_TEXT_SCROLL_WHEEL *)a,                                                 \
											(UINT(*)(GX_TEXT_SCROLL_WHEEL *, INT, GX_STRING *))b)
#define gx_text_scroll_wheel_font_set(a, b, c) _gxe_text_scroll_wheel_font_set((GX_TEXT_SCROLL_WHEEL *)a, b, c)
#if defined(GUIX_5_4_0_COMPATIBILITY)
#define gx_text_scroll_wheel_text_color_set(a, b, c)                                                                   \
	_gxe_text_scroll_wheel_text_color_set((GX_TEXT_SCROLL_WHEEL *)a, b, c, b)
#else
#define gx_text_scroll_wheel_text_color_set(a, b, c, d)                                                                \
	_gxe_text_scroll_wheel_text_color_set((GX_TEXT_SCROLL_WHEEL *)a, b, c, d)
#endif
#define gx_text_scroll_wheel_create(a, b, c, d, e, f, g)                                                               \
	_gxe_text_scroll_wheel_create(a, b, c, d, e, f, g, sizeof(GX_TEXT_SCROLL_WHEEL))
#define gx_text_scroll_wheel_draw _gx_text_scroll_wheel_draw
...
#define gx_tree_view_create(a, b, c, d, e, f)                                                                          \
	_gxe_tree_view_create((GX_TREE_VIEW *)a, b, (GX_WIDGET *)c, d, e, f, sizeof(GX_TREE_VIEW))
#define gx_tree_view_draw _gx_tree_view_draw
...
#define gx_vertical_list_create(a, b, c, d, e, f, g, h)                                                                \
	_gxe_vertical_list_create(a, b, (GX_WIDGET *)c, d, e, f, g, h, sizeof(GX_VERTICAL_LIST))
...
#define gx_vertical_scrollbar_create(a, b, c, d, e)                                                                    \
	_gxe_vertical_scrollbar_create(a, b, (GX_WINDOW *)c, d, e, sizeof(GX_SCROLLBAR))
...
#define gx_widget_create(a, b, c, d, e, f)                                                                             \
	_gxe_widget_create((GX_WIDGET *)a, b, (GX_WIDGET *)c, d, e, f, sizeof(GX_WIDGET))
...
#define gx_widget_event_process_set(a, b)                                                                              \
	_gxe_widget_event_process_set((GX_WIDGET *)a, (UINT(*)(GX_WIDGET *, GX_EVENT *))b)
...
UINT _gxe_accordion_menu_create(GX_ACCORDION_MENU *accordion, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style,
								USHORT accordion_menu_id, GX_CONST GX_RECTANGLE *size, UINT control_block_size);
VOID _gx_accordion_menu_draw(GX_ACCORDION_MENU *menu);
...
VOID _gx_button_background_draw(GX_BUTTON *button);
UINT _gxe_button_create(GX_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style, USHORT Id,
...
UINT _gxe_canvas_pixelmap_rotate(GX_VALUE x_position, GX_VALUE y_position, GX_PIXELMAP *pixelmap, INT angle, INT rot_cx,
								 INT rot_cy);
...
UINT _gxe_checkbox_create(GX_CHECKBOX *checkbox, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID text_id,
						  ULONG style, USHORT checkbox_id, GX_CONST GX_RECTANGLE *size,
...
VOID _gx_circular_gauge_background_draw(GX_CIRCULAR_GAUGE *gauge);
UINT _gxe_circular_gauge_create(GX_CIRCULAR_GAUGE *circular_gauge, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
								GX_CIRCULAR_GAUGE_INFO *circular_gauge_info, GX_RESOURCE_ID background, ULONG style,
								USHORT circular_gauge_id, GX_VALUE xpos, GX_VALUE ypos,
								UINT checkbox_control_block_size);
VOID _gx_circular_gauge_draw(GX_CIRCULAR_GAUGE *circular_gauge);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_display_language_table_get(GX_DISPLAY *display, GX_CHAR ****table, GX_UBYTE *language_count,
									 UINT *string_count);
UINT _gxe_display_language_table_set(GX_DISPLAY *display, GX_CHAR ***table, GX_UBYTE num_languages,
									 UINT number_of_strings);
#endif
UINT _gxe_display_language_table_get_ext(GX_DISPLAY *display, GX_STRING ***table, GX_UBYTE *language_count,
										 UINT *string_count);
UINT _gxe_display_language_table_set_ext(GX_DISPLAY *display, GX_CONST GX_STRING **table, GX_UBYTE num_languages,
										 UINT number_of_strings);
...
UINT _gxe_drop_list_create(GX_DROP_LIST *drop_list, GX_CONST GX_CHAR *name, GX_WIDGET *parent, INT total_rows,
						   INT open_height, VOID (*callback)(GX_VERTICAL_LIST *, GX_WIDGET *, INT), ULONG style,
						   USHORT drop_list_id, GX_CONST GX_RECTANGLE *size, UINT drop_list_control_block_size);
...
UINT _gxe_icon_create(GX_ICON *icon, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID pixelmap_id, ULONG style,
					  USHORT icon_id, GX_VALUE x, GX_VALUE y, UINT icon_control_block_size);
VOID _gx_icon_draw(GX_ICON *icon);
...
UINT _gxe_image_reader_create(GX_IMAGE_READER *image_reader, GX_CONST GX_UBYTE *read_data, INT read_data_size,
							  GX_UBYTE color_format, GX_UBYTE mode);
...
VOID _gx_line_chart_axis_draw(GX_LINE_CHART *chart);
UINT _gxe_line_chart_create(GX_LINE_CHART *chart, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
							GX_CONST GX_LINE_CHART_INFO *info, ULONG style, USHORT chart_id,
							GX_CONST GX_RECTANGLE *size, UINT chart_control_block_size);
VOID _gx_line_chart_data_draw(GX_LINE_CHART *chart);
VOID _gx_line_chart_draw(GX_LINE_CHART *chart);
...
UINT _gxe_menu_create(GX_MENU *menu, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID text_id,
					  GX_RESOURCE_ID fill_id, ULONG style, USHORT menu_id, GX_CONST GX_RECTANGLE *size,
...
UINT _gxe_multi_line_text_input_create(GX_MULTI_LINE_TEXT_INPUT *text_input_ptr, GX_CONST GX_CHAR *name_ptr,
									   GX_WIDGET *parent, GX_CHAR *input_buffer, UINT buffer_size, ULONG style,
									   USHORT Id, GX_CONST GX_RECTANGLE *size, UINT text_input_control_block_size);
...
UINT _gxe_multi_line_text_input_fill_color_set(GX_MULTI_LINE_TEXT_INPUT *view, GX_RESOURCE_ID normal_color_id,
											   GX_RESOURCE_ID selected_color_id, GX_RESOURCE_ID disabled_color_id,
...
UINT _gxe_multi_line_text_input_text_color_set(GX_MULTI_LINE_TEXT_INPUT *view, GX_RESOURCE_ID normal_color_id,
											   GX_RESOURCE_ID selected_color_id, GX_RESOURCE_ID disabled_color_id,
											   GX_RESOURCE_ID readonly_color_id);
...
UINT _gxe_multi_line_text_view_create(GX_MULTI_LINE_TEXT_VIEW *text_view_ptr, GX_CONST GX_CHAR *name_ptr,
									  GX_WIDGET *parent, GX_RESOURCE_ID text_id, ULONG style, USHORT Id,
									  GX_CONST GX_RECTANGLE *size, UINT text_view_control_block_size);
VOID _gx_multi_line_text_view_draw(GX_MULTI_LINE_TEXT_VIEW *view);
...
UINT _gxe_multi_line_text_view_scroll_info_get(GX_MULTI_LINE_TEXT_VIEW *view, ULONG style,
											   GX_SCROLL_INFO *return_scroll_info);
UINT _gxe_multi_line_text_view_text_color_set(GX_MULTI_LINE_TEXT_VIEW *view, GX_RESOURCE_ID normal_color_id,
											  GX_RESOURCE_ID selected_color_id, GX_RESOURCE_ID disabled_color_id);
...
UINT _gxe_rich_text_view_create(GX_RICH_TEXT_VIEW *rich_view, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
								GX_RESOURCE_ID text_id, GX_RICH_TEXT_FONTS *fonts, ULONG style, USHORT id,
...
UINT _gxe_numeric_pixelmap_prompt_create(GX_NUMERIC_PIXELMAP_PROMPT *prompt, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
										 GX_RESOURCE_ID text_id, GX_RESOURCE_ID fill_id, ULONG style,
										 USHORT pixelmap_prompt_id, GX_CONST GX_RECTANGLE *size,
										 UINT control_block_size);
UINT _gxe_numeric_pixelmap_prompt_format_function_set(GX_NUMERIC_PIXELMAP_PROMPT *prompt,
													  VOID (*format_func)(GX_NUMERIC_PIXELMAP_PROMPT *, INT));
...
UINT _gxe_pixelmap_prompt_create(GX_PIXELMAP_PROMPT *prompt, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
								 GX_RESOURCE_ID text_id, GX_RESOURCE_ID normal_pixelmap_id, ULONG style,
								 USHORT prompt_id, GX_CONST GX_RECTANGLE *size,
								 UINT pixelmap_prompt_control_block_size);
VOID _gx_pixelmap_prompt_draw(GX_PIXELMAP_PROMPT *prompt);
UINT _gxe_pixelmap_prompt_pixelmap_set(GX_PIXELMAP_PROMPT *prompt, GX_RESOURCE_ID normal_left_id,
									   GX_RESOURCE_ID normal_fill_id, GX_RESOURCE_ID normal_right_id,
									   GX_RESOURCE_ID selected_left_id, GX_RESOURCE_ID selected_fill_id,
									   GX_RESOURCE_ID selected_right_id);
...
UINT _gxe_progress_bar_create(GX_PROGRESS_BAR *progress_bar, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
							  GX_PROGRESS_BAR_INFO *progress_bar_info, ULONG style, USHORT progress_bar_id,
							  GX_CONST GX_RECTANGLE *size, UINT progress_bar_control_block_size);
VOID _gx_progress_bar_draw(GX_PROGRESS_BAR *progress_bar);
...
UINT _gxe_prompt_text_color_set(GX_PROMPT *prompt, GX_RESOURCE_ID normal_text_color_id,
								GX_RESOURCE_ID selected_text_color_id, GX_RESOURCE_ID disabled_text_color_id);
VOID _gx_prompt_text_draw(GX_PROMPT *prompt);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
...
VOID _gx_radial_progress_bar_background_draw(GX_RADIAL_PROGRESS_BAR *progress_bar);
UINT _gxe_radial_progress_bar_create(GX_RADIAL_PROGRESS_BAR *progress_bar, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
									 GX_RADIAL_PROGRESS_BAR_INFO *progress_bar_info, ULONG style,
									 USHORT progress_bar_id, UINT progress_bar_control_block_size);
VOID _gx_radial_progress_bar_draw(GX_RADIAL_PROGRESS_BAR *progress_bar);
...
UINT _gxe_radial_progress_bar_text_color_set(GX_RADIAL_PROGRESS_BAR *progress_bar, GX_RESOURCE_ID normal_text_color_id,
											 GX_RESOURCE_ID selected_text_color_id,
											 GX_RESOURCE_ID disabled_text_color_id);
VOID _gx_radial_progress_bar_text_draw(GX_RADIAL_PROGRESS_BAR *bar);
...
UINT _gxe_radial_slider_pixelmap_set(GX_RADIAL_SLIDER *slider, GX_RESOURCE_ID background_pixelmap,
									 GX_RESOURCE_ID needle_pixelmap);
...
UINT _gxe_radio_button_create(GX_RADIO_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
							  GX_RESOURCE_ID text_id, ULONG style, USHORT radio_button_id, GX_CONST GX_RECTANGLE *size,
...
UINT _gxe_single_line_text_input_create(GX_SINGLE_LINE_TEXT_INPUT *text_input_ptr, GX_CONST GX_CHAR *name,
										GX_WIDGET *parent, GX_CHAR *input_buffer, UINT buffer_size, UINT style,
										USHORT text_input_id, GX_CONST GX_RECTANGLE *size,
...
UINT _gxe_single_line_text_input_fill_color_set(GX_SINGLE_LINE_TEXT_INPUT *input, GX_RESOURCE_ID normal_color_id,
												GX_RESOURCE_ID selected_color_id, GX_RESOURCE_ID disabled_color_id,
												GX_RESOURCE_ID readonly_color_id);
UINT _gxe_single_line_text_input_text_color_set(GX_SINGLE_LINE_TEXT_INPUT *input, GX_RESOURCE_ID normal_color_id,
												GX_RESOURCE_ID selected_color_id, GX_RESOURCE_ID disabled_color_id,
												GX_RESOURCE_ID readonly_color_id);
...
UINT _gxe_sprite_create(GX_SPRITE *sprite, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_SPRITE_FRAME *frame_list,
						USHORT framecount, ULONG style, USHORT sprite_id, GX_CONST GX_RECTANGLE *size,
						UINT sprite_control_block_size);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_string_scroll_wheel_create(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
									 INT value_count, GX_CONST GX_CHAR **string_list, ULONG style, USHORT Id,
									 GX_CONST GX_RECTANGLE *size, UINT control_block_size);
#endif
UINT _gxe_string_scroll_wheel_create_ext(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
										 INT total_rows, GX_CONST GX_STRING *string_list, ULONG style, USHORT Id,
										 GX_CONST GX_RECTANGLE *size, UINT control_block_size);
UINT _gxe_string_scroll_wheel_event_process(GX_STRING_SCROLL_WHEEL *wheel, GX_EVENT *event_ptr);
UINT _gxe_string_scroll_wheel_string_id_list_set(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_RESOURCE_ID *string_id_list,
												 INT id_count);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_string_scroll_wheel_string_list_set(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR **string_list,
											  INT string_count);
#endif
UINT _gxe_string_scroll_wheel_string_list_set_ext(GX_STRING_SCROLL_WHEEL *wheel, GX_CONST GX_STRING *string_list,
												  INT string_count);
...
UINT _gxe_system_string_width_get(GX_CONST GX_FONT *font, GX_CONST GX_CHAR *string, INT string_length,
								  GX_VALUE *return_width);
#endif
...
UINT _gxe_text_button_create(GX_TEXT_BUTTON *button, GX_CONST GX_CHAR *name, GX_WIDGET *parent, GX_RESOURCE_ID text_id,
							 ULONG style, USHORT Id, GX_CONST GX_RECTANGLE *size, UINT text_button_control_block_size);
VOID _gx_text_button_draw(GX_TEXT_BUTTON *button);
...
UINT _gxe_text_button_text_color_set(GX_TEXT_BUTTON *_text_button, GX_RESOURCE_ID normal_text_color_id,
									 GX_RESOURCE_ID selected_text_color_id, GX_RESOURCE_ID disabled_text_color_id);
VOID _gx_text_button_text_draw(GX_TEXT_BUTTON *button);
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_text_scroll_wheel_callback_set(GX_TEXT_SCROLL_WHEEL *wheel,
										 GX_CONST GX_CHAR *(*callback)(GX_TEXT_SCROLL_WHEEL *, INT));
#endif
UINT _gxe_text_scroll_wheel_callback_set_ext(GX_TEXT_SCROLL_WHEEL *wheel,
											 UINT (*callback)(GX_TEXT_SCROLL_WHEEL *, INT, GX_STRING *));
UINT _gxe_text_scroll_wheel_font_set(GX_TEXT_SCROLL_WHEEL *wheel, GX_RESOURCE_ID normal_font,
									 GX_RESOURCE_ID selected_font);
UINT _gxe_text_scroll_wheel_text_color_set(GX_TEXT_SCROLL_WHEEL *wheel, GX_RESOURCE_ID normal_text_color,
										   GX_RESOURCE_ID selected_text_color, GX_RESOURCE_ID disabled_text_color);
UINT _gxe_text_scroll_wheel_create(GX_TEXT_SCROLL_WHEEL *wheel, GX_CONST GX_CHAR *name, GX_WIDGET *parent,
								   INT value_count, ULONG style, USHORT Id, GX_CONST GX_RECTANGLE *size,
								   UINT control_block_size);
UINT _gxe_text_scroll_wheel_event_process(GX_TEXT_SCROLL_WHEEL *wheel, GX_EVENT *event_ptr);
VOID _gx_text_scroll_wheel_draw(GX_TEXT_SCROLL_WHEEL *wheel);

UINT _gxe_tree_view_create(GX_TREE_VIEW *tree, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style, USHORT tree_id,
						   GX_CONST GX_RECTANGLE *size, UINT control_block_size);
VOID _gx_tree_view_draw(GX_TREE_VIEW *tree);
...
UINT _gxe_utility_gradient_create(GX_GRADIENT *gradient, GX_VALUE width, GX_VALUE height, UCHAR type, UCHAR alpha_start,
								  UCHAR alpha_end);
UINT _gxe_utility_gradient_delete(GX_GRADIENT *gradient);
#if defined(GX_DYNAMIC_BIDI_TEXT_SUPPORT)
UINT _gxe_utility_bidi_paragraph_reorder(GX_BIDI_TEXT_INFO *input_info,
...
#endif
UINT _gxe_utility_canvas_to_bmp(GX_CANVAS *canvas, GX_RECTANGLE *rect,
								UINT (*write_data)(GX_UBYTE *byte_data, UINT data_count));
...
UINT _gxe_utility_pixelmap_simple_rotate(GX_PIXELMAP *src, INT angle, GX_PIXELMAP *destination, INT *rot_cx,
										 INT *rot_cy);
...
UINT _gxe_utility_rectangle_define(GX_RECTANGLE *rectangle, GX_VALUE left, GX_VALUE top, GX_VALUE right,
								   GX_VALUE bottom);
...
UINT _gxe_vertical_scrollbar_create(GX_SCROLLBAR *scrollbar, GX_CONST GX_CHAR *name, GX_WINDOW *parent,
									GX_SCROLLBAR_APPEARANCE *settings, ULONG style, UINT scrollbar_control_blcok_size);
...
UINT _gxe_widget_create(GX_WIDGET *widget, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style, USHORT Id,
						GX_CONST GX_RECTANGLE *size, UINT widget_block_size);
...
#if defined(GX_ENABLE_DEPRECATED_STRING_API)
UINT _gxe_widget_text_blend(GX_WIDGET *widget, UINT tColor, UINT font_id, GX_CONST GX_CHAR *string, INT x_offset,
							INT y_offset, UCHAR alpha);
VOID _gx_widget_text_draw(GX_WIDGET *widget, UINT tColor, UINT font_id, GX_CONST GX_CHAR *string, INT x_offset,
						  INT y_offset);
#endif
UINT _gxe_widget_text_blend_ext(GX_WIDGET *widget, UINT tColor, UINT font_id, GX_CONST GX_STRING *string, INT x_offset,
								INT y_offset, UCHAR alpha);
...
UINT _gxe_window_create(GX_WINDOW *window, GX_CONST GX_CHAR *name, GX_WIDGET *parent, ULONG style, USHORT Id,
						GX_CONST GX_RECTANGLE *size, UINT window_control_block_size);
VOID _gx_window_draw(GX_WINDOW *window);
...
UINT _gxe_window_root_create(GX_WINDOW_ROOT *root_window, GX_CONST GX_CHAR *name, GX_CANVAS *canvas, ULONG style,
							 USHORT Id, GX_CONST GX_RECTANGLE *size, UINT root_window_control_block_size);
